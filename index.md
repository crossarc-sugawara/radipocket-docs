---
title: らじぽけ
description: Android 向けのラジオ録音アプリ「らじぽけ」の紹介です。radiko の放送を聴き、番組を録音して、あとから好きなときに聴けます。Android 6.0 以降で動きます。
---
...
radiko で配信されている放送を、いま流れているところからでも、放送が終わったあとからでも聴けます。番組はそのまま端末に録音できるので、電波の届かないところでも、あとから好きなときに聴けます。お気に入りに入れた番組は、放送のたびに自動で録音します。

Android 6.0 以降で動きます。

機能の名前のうしろに（プレミアム）などと書いてあるものは、そのプラン以上でお使いいただけます。何も書いていないものは、どのプランでも使えます。くわしくは [料金](#料金) をご覧ください。
